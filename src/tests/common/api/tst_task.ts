...
describe("API TaskBuilder", () => {
    it("Should create a Task from correct input", () => {
    ...
    it("Should not create a task from an input without identifier", () => {
        const apiTask = {
            name: "Name",
            description: "Description",
            estimatedStartDate: new Date(2015, 1, 15).toISOString(),
    ...
    it("Should not create a task from an input with a wrong identifier type", () => {
        const apiTask = {
    ...
    it("Should not fromObject a task without name", () => {
        const apiTask = {
            identifier: "identifier",
            description: "Description",
            estimatedStartDate: new Date(2015, 1, 15).toISOString(),
    ...
    it("Should not fromObject a task with a wrong name type", () => {
        const apiTask = {
            identifier: "identifier",
            name: {test: "test"},
            description: "Description",
    ...
    it("Should not fromObject a task without description", () => {
        const apiTask = {
            identifier: "identifier",
            name: "Name",
            estimatedStartDate: new Date(2015, 1, 15).toISOString(),
    ...
    it("Should not fromObject a task with a wrong description type", () => {
        const apiTask = {
            identifier: "identifier",
            name: "Name",
    ...
    it("Should not fromObject a task without estimatedStartDate", () => {
        const apiTask = {
            identifier: "identifier",
            name: "Name",
            description: "Description",
    ...
    it("Should not fromObject a task with a wrong estimatedStartDate type", () => {
        const apiTask = {
            identifier: "identifier",
            name: "Name",
            description: "Description",
    ...
    it("Should not fromObject a task without estimatedDuration", () => {
        const apiTask = {
            identifier: "identifier",
            name: "Name",
            description: "Description",
    ...
    it("Should not fromObject a task with a wrong estimatedDuration type", () => {
        const apiTask = {
            identifier: "identifier",
            name: "Name",
            description: "Description",
