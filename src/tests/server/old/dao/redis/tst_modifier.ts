...
import {RedisModifierDao} from "../../../../../server/old/dao/redis/modifier"
...
describe("Redis DAO Modifier", () => {
    ...
    describe("getModifier", () => {
        ...
        xit("Should get an exception for an invalid modifier id", () => {
        ...
        xit("Should get an exception for a modifier with corrupted name", () => {
        ...
        xit("Should get an exception for a modifier with corrupted description", () => {
            const modifierKey = KeyFactory.createModifierKey(project1.identifier, 1)
        ...
        xit("Should get an exception for a modifier with corrupted location", () => {
            const modifierKey = KeyFactory.createModifierKey(project1.identifier, 1)
        ...
        xit("Should get an exception for a modifier with an invalid location", () => {
            const modifierKey = KeyFactory.createModifierKey(project1.identifier, 1)
        ...
        xit("Should get an exception for a modifier with corrupted duration", () => {
        ...
        xit("Should get an exception for a corrupted modifier", () => {
            const modifierKey = KeyFactory.createModifierKey(project1.identifier, 1)
    ...
    describe("getTaskModifiers", () => {
        xit("Should get a list of tasks that belongs to a task from the DB", () => {
        ...
        xit("Should get an exception for an invalid taskidentifier", () => {
        ...
        xit("Should get only modifiers without corrupted body from the DB", () => {
            const modifierKey = KeyFactory.createModifierKey(project1.identifier, 1)
            return RedisTestDataProvider.setValue(client, modifierKey, "test").then(() => {
    ...
    describe("addModifier", () => {
        xit("Should add a modifier in the DB", () => {
            return dao.addModifier(project1.identifier, modifier4)
        })
        xit("Should get an exception when adding a modifier in the DB with an invalid location type", () => {
        ...
        xit("Should get an exception when adding a modifier in the DB for an invalid project", () => {
        ...
        xit("Should get an exception when adding a modifier in a project with corrupted latest modifier id", () => {
        ...
        xit("Should get an exception when adding a modifier in a project with corrupted modifier ids", () => {
    ...
    describe("addModifierForTask", () => {
        xit("Should add a modifier to a task", () => {
        ...
        xit("Should get an exception when adding a modifier with corrupted task identifiers to a task", () => {
        ...
        xit("Should get an exception when adding a modifier to a task with corrupted modifier ids", () => {
