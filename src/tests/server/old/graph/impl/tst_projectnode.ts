...
import {ProjectNode} from "../../../../../server/old/graph/impl/projectnode"
...
describe("Graph project node", () => {
    ...
    xit("Should add a new task in the graph", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        let mockNodeFactory = sinon.mock(nodeFactory)
    ...
    xit("Should get an exception when adding an existing task", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        let mockNodeFactory = sinon.mock(nodeFactory)
    ...
    xit("Should add a new relation between tasks in the graph", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        const graph = new MockGraph()
    ...
    xit("Should get an exception when adding relation with invalid previous node", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        const graph = new MockGraph()
    ...
    xit("Should get an exception when adding relation with invalid next node", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        const graph = new MockGraph()
    ...
    xit("Should add a new delay in the graph", () => {
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        let mockNodeFactory = sinon.mock(nodeFactory)
        const graph = new MockGraph()
    ...
    xit("Should get an exception when adding an existing delay", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        let mockNodeFactory = sinon.mock(nodeFactory)
    ...
    xit("Should add a new relation between a delay and a task in the graph", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        const graph = new MockGraph()
    ...
    xit("Should get an exception when adding relation with invalid task node", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        const graph = new MockGraph()
    ...
    xit("Should get an exception when adding relation with invalid delay node", () => {
        // Graph
        const daoBuilder = new MockDaoBuilder()
        const nodeFactory = new MockNodeFactory()
        const graph = new MockGraph()
