...
import {TaskNode} from "../../../../../server/old/graph/impl/tasknode"
...
import {diffDates, addDays} from "../../../../../common/old/utils/date"
import {MockTaskNode} from "../mocktasknode"

describe("Graph task node", () => {
    xit("Should not compute when not needed", () => {
    ...
    xit("Should get an exception for an invalid date", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
        const node = new TaskNode(daoBuilder, projectNode, taskd1.identifier,
    ...
    xit("Should compute the correct results based on modifiers at task end", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
    ...
    xit("Should compute the correct results based on modifiers at task beginning", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
        const node = new TaskNode(daoBuilder, projectNode, taskd4.identifier,
    ...
    xit("Should compute children when they are added", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
    ...
    xit("Should recompute when adding modifiers", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
        const node1 = new TaskNode(daoBuilder, projectNode, taskd1.identifier,
    ...
    xit("Should correctly compute milestones", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
    ...
    xit("Should take the parents in account when computing (Relation with End)", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
        const node1 = new TaskNode(daoBuilder, projectNode, taskd1.identifier,
    ...
    xit("Should take the parents in account when computing (Relation with Beginning)", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
    ...
    xit("Should detect cyclic dependencies", () => {
        const daoBuilder = new MockDaoBuilder()
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
        const node1 = new TaskNode(daoBuilder, projectNode, taskd1.identifier,
