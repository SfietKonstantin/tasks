...
import {ApiTaskDefinition, TaskBuilder} from "../../../../common/old/api/task"
import {ApiDelayDefinition, DelayBuilder} from "../../../../common/old/api/delay"
import {ImportApiProvider} from "../../../../server/old/api/import"
...
describe("API import", () => {
    ...
    describe("import", () => {
        ...
        xit("Should import tasks and relations", () => {
        ...
        xit("Should get an exception on existing project", () => {
            mockGraph.expects("addProject").once()
                .withExactArgs(project1)
        ...
        xit("Should get an exception on existing task", () => {
            let projectNode = new MockProjectNode(graph, project1.identifier)
            mockGraph.expects("addProject").once()
                .withExactArgs(project1)
                .returns(Promise.resolve(projectNode))
        ...
        xit("Should get an exception on inexisting task relation", () => {
            let projectNode = new MockProjectNode(graph, project1.identifier)
            mockGraph.expects("addProject").once()
                .withExactArgs(project1)
                .returns(Promise.resolve(projectNode))
        ...
        xit("Should get an exception on existing delay", () => {
            let projectNode = new MockProjectNode(graph, project1.identifier)
            mockGraph.expects("addProject").once()
                .withExactArgs(project1)
                .returns(Promise.resolve(projectNode))
        ...
        xit("Should get an exception on internal error for delay", () => {
            let projectNode = new MockProjectNode(graph, project1.identifier)
            mockGraph.expects("addProject").once()
                .withExactArgs(project1)
                .returns(Promise.resolve(projectNode))
        ...
        xit("Should get an exception on inexisting delay relation", () => {
            let projectNode = new MockProjectNode(graph, project1.identifier)
            mockGraph.expects("addProject").once()
                .withExactArgs(project1)
                .returns(Promise.resolve(projectNode))
        ...
        xit("Should get an exception for an invalid project input", () => {
        ...
        xit("Should get an exception for an invalid task list input", () => {
        ...
        xit("Should get an exception for an invalid task input", () => {
            return apiProvider.import(project1, [{test: "test"}], taskRelations, delays, delayRelations).then(() => {
                throw new Error("import should not be a success")
            }).catch((error) => {
                chai.expect(error).to.instanceOf(RequestError)
        ...
        xit("Should get an exception for an invalid task relation list input", () => {
        ...
        xit("Should get an exception for an invalid task relation input", () => {
            return apiProvider.import(project1, tasks, [{test: "test"}], delays, delayRelations).then(() => {
                throw new Error("import should not be a success")
            }).catch((error) => {
                chai.expect(error).to.instanceOf(RequestError)
        ...
        xit("Should get an exception for an invalid delay list input", () => {
        ...
        xit("Should get an exception for an invalid delay input", () => {
            return apiProvider.import(project1, tasks, taskRelations, [{test: "test"}], delayRelations).then(() => {
                throw new Error("import should not be a success")
            }).catch((error) => {
                chai.expect(error).to.instanceOf(RequestError)
        ...
        xit("Should get an exception for an invalid delay relation list input", () => {
        ...
        xit("Should get an exception for an invalid delay relation input", () => {
            return apiProvider.import(project1, tasks, taskRelations, delays, [{test: "test"}]).then(() => {
                throw new Error("import should not be a success")
            }).catch((error) => {
                chai.expect(error).to.instanceOf(RequestError)
