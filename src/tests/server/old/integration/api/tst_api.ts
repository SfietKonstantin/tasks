...
import {TaskBuilder} from "../../../../../common/old/api/task"
...
describe("Integration API", () => {
    ...
    xit("Should get a list of projects", (done) => {
    ...
    xit("Should tasks for a project", (done) => {
    ...
    xit("Should get if a task is important (false)", (done) => {
        supertest("http://localhost:8080")
    ...
    xit("Should get if a task is important (true)", (done) => {
        supertest("http://localhost:8080")
    ...
    xit("Should set if a task is important (true)", (done) => {
        supertest("http://localhost:8080")
    ...
    xit("Should set if a task is important (false)", (done) => {
        supertest("http://localhost:8080")
    ...
    xit("Should add a modifier", (done) => {
