...
describe("Graph delay node", () => {
    it("Should compute initial margin and current margin without impacted end date and lag", () => {
    ...
    it("Should compute initial margin and current margin with lag", () => {
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
    ...
    it("Should compute initial margin and current margin with impacted end date", () => {
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
        const task1Node = new MockTaskNode(projectNode, taskd1.identifier,
            taskd1.estimatedStartDate, taskd1.estimatedDuration)
    ...
    it("Should compute initial margin and current margin with multiple tasks", () => {
        const graph = new MockGraph()
        const projectNode = new MockProjectNode(graph, project1.identifier)
        const task1Node = new MockTaskNode(projectNode, taskd1.identifier,
            taskd1.estimatedStartDate, taskd1.estimatedDuration)
