...
describe("Redis DAO TaskRelation", () => {
    ...
    describe("getTaskRelations", () => {
        it("Should get a list of task relations that belongs to a task from the DB", () => {
        ...
        it("Should get an exception for a task relation with corrupted previousLocation", () => {
        ...
        it("Should get an exception for a task relation with corrupted lag", () => {
            const taskRelationKey = KeyFactory.createTaskRelationKey(project1.identifier, taskRelation1.previous,
                taskRelation1.next)
        ...
        it("Should get an exception for a task relation with an invalid previousLocation", () => {
            const taskRelationKey = KeyFactory.createTaskRelationKey(project1.identifier, taskRelation1.previous,
                taskRelation1.next)
        ...
        it("Should get an exception when a task relation is missing in the DB", () => {
            const taskRelationKey = KeyFactory.createTaskRelationKey(project1.identifier, taskRelation1.previous,
                taskRelation1.next)
        ...
        it("Should get an exception for a task with corrupted relations", () => {
    ...
    describe("addTaskRelation", () => {
        it("Should add a task relation in the DB", () => {
        ...
        it("Should get an exception for an invalid parent task", () => {
        ...
        it("Should get an exception for an invalid child task", () => {
        ...
        it("Should get an exception when adding an existing task relation in the DB", () => {
        ...
        it("Should get an exception when adding a task relation to a task with corrupted relations", () => {
