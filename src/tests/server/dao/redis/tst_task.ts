...
import {RedisTaskDao} from "../../../../server/dao/redis/old/task"
import {RedisDaoBuilder} from "../../../../server/dao/redis/builder"
import {RedisTestDataProvider} from "./testdataprovider"
import {project1, invalidProject, taskd1, taskd2, taskd3, taskd4, invalidTaskd} from "../../../common/testdata"
...
describe("Redis DAO Task", () => {
    ...
    describe("getTask", () => {
        it("Should get a task from the DB", () => {
        ...
        it("Should get an exception for a task with corrupted name", () => {
        ...
        it("Should get an exception for a task with corrupted description", () => {
            const taskKey = KeyFactory.createTaskKey(project1.identifier, taskd1.identifier)
        ...
        it("Should get an exception for a task with corrupted estimatedStartDate", () => {
        ...
        it("Should get an exception for a task with corrupted estimatedDuration", () => {
        ...
        it("Should get an exception for a corrupted task", () => {
            const taskKey = KeyFactory.createTaskKey(project1.identifier, taskd1.identifier)
    ...
    describe("getProjectTasks", () => {
        it("Should get a list of tasks that belongs to a project from the DB", () => {
        ...
        it("Should only get tasks with body from the DB", () => {
        ...
        it("Should only get tasks without corrupted body from the DB", () => {
            const projectKey = KeyFactory.createTaskKey(project1.identifier, taskd1.identifier)
    ...
    describe("addTask", () => {
        it("Should add a task in the DB", () => {
        ...
        it("Should get an exception when adding a task in the DB for an invalid project", () => {
        ...
        it("Should get an exception when adding an existing task in the DB", () => {
        ...
        it("Should get an exception when adding a task in a project with corrupted task ids", () => {
    ...
    describe("isTaskImportant", () => {
        it("Should check that a task that is not important will be reported as non-important", () => {
            return dao.isTaskImportant(project1.identifier, taskd1.identifier).then((important: boolean) => {
                chai.expect(important).to.false
            })
        })
        it("Should check that a task that is important will be reported as important", () => {
        ...
        it("Should get an exception when checking if a task is important for an invalid project", () => {
        ...
        it("Should get an exception when checking if a task is important for an invalid task", () => {
        ...
        it("Should get an exception when checking if a task is important for a corrupted task", () => {
            const projectImportantTasksKey = KeyFactory.createProjectKey(project1.identifier, "task:important")
    ...
    describe("setTaskImportant", () => {
        it("Should set task as important", () => {
        ...
        it("Should not affect an important task when setting this task as important", () => {
            const projectImportantTasksKey = KeyFactory.createProjectKey(project1.identifier, "task:important")
            return RedisTestDataProvider.addValue(client, projectImportantTasksKey, taskd1.identifier).then(() => {
        ...
        it("Should set task as not important", () => {
            const projectImportantTasksKey = KeyFactory.createProjectKey(project1.identifier, "task:important")
            return RedisTestDataProvider.addValue(client, projectImportantTasksKey, taskd1.identifier).then(() => {
        ...
        it("Should not affecting a non-important task when setting this task as not important", () => {
        ...
        it("Should get an exception when setting a task as important for an invalid project", () => {
        ...
        it("Should get an exception when setting a task as not important for an invalid project", () => {
        ...
        it("Should get an exception when setting a task as important for an invalid task", () => {
        ...
        it("Should get an exception when setting a task as important for a corrupted task", () => {
            const projectImportantTasksKey = KeyFactory.createProjectKey(project1.identifier, "task:important")
            return RedisTestDataProvider.setValue(client, projectImportantTasksKey, "test").then(() => {
                return dao.setTaskImportant(project1.identifier, taskd1.identifier, true)
            }).then(() => {
        ...
        it("Should get an exception when setting a task as not important for a corrupted task", () => {
            const projectImportantTasksKey = KeyFactory.createProjectKey(project1.identifier, "task:important")
            return RedisTestDataProvider.setValue(client, projectImportantTasksKey, "test").then(() => {
                return dao.setTaskImportant(project1.identifier, taskd1.identifier, false)
            }).then(() => {
