...
describe("Redis DAO DelayRelation", () => {
    ...
    describe("getDelayRelations", () => {
        it("Should get a list of task relations that belongs to a delay from the DB", () => {
        ...
        it("Should get an exception when a delay relation is missing in the DB", () => {
        ...
        it("Should get an exception for a delay with corrupted relations", () => {
    ...
    describe("addDelayRelation", () => {
        it("Should add a delay relation in the DB", () => {
        ...
        it("Should get an exception for an invalid delay", () => {
        ...
        it("Should get an exception for an invalid task", () => {
        ...
        it("Should get an exception when adding an existing delay relation in the DB", () => {
        ...
        it("Should get an exception when adding a delay relation to a delay with corrupted relations", () => {
